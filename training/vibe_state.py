...
class TrainConfig:
    ...
    blending_forward_gate_sharpness: any
    blending_forward_gate_center: any
    ...
    def init(
        ...
        blending_forward_gate_sharpness=1.0,
        blending_forward_gate_center=-8.0,
        ...
        return cls(
            ...
            blending_forward_gate_sharpness=blending_forward_gate_sharpness,
            blending_forward_gate_center=blending_forward_gate_center,
    ...
    def make_dict(self):
        return {
            ...
            "blending_forward_gate_sharpness": self.blending_forward_gate_sharpness,
            "blending_forward_gate_center": self.blending_forward_gate_center,
    ...
    def tree_unflatten(cls, aux, data):
        return cls.init(
            ...
            blending_forward_gate_sharpness=aux["blending_forward_gate_sharpness"],
            blending_forward_gate_center=aux["blending_forward_gate_center"],
